...
FactoryBot.define do
  ...
  factory :review do
    ...
    trait :with_incomplete_draft_criteria_review do
      after(:create) do |review|
        review.grant_criteria.each do |criterion|
          create(:draft_criteria_review, criterion: criterion, review: review)
        end
      end
    end

    trait :with_scored_draft_criteria_review do
      after(:create) do |review|
        review.grant_criteria.each do |criterion|
          create(:scored_draft_criteria_review, criterion: criterion, review: review)
        end
      end
    end
    ...
    factory :scored_review_with_scored_mandatory_criteria_review,
            traits: %i[with_score with_scored_mandatory_criteria_review reload_submission]
    factory :scored_review_with_scored_commented_criteria_review,
            traits: %i[with_score with_comment with_scored_and_commented_criteria_review reload_submission]
    factory :draft_review_with_incomplete_criteria_review,
            traits: %i[draft with_score with_incomplete_draft_criteria_review reload_submission]
    factory :draft_review_with_scored_criteria_review,
            traits: %i[draft with_score with_scored_draft_criteria_review reload_submission]
  end
end
