  ...
  context 'panel is not today' do
    ...
    context 'will_close_at_string' do
      it 'includes date in string' do
        ...
        expect(will_close_at_string).to include panel.end_datetime.strftime('%l:%M%P')
        expect(will_close_at_string).to include "on #{panel.end_datetime.strftime('%-m/%-d/%Y')}"
      end
    end
    ...
    context 'will_open_at_string' do
      it 'includes date in string' do
        ...
        expect(will_open_at_string).to include panel.start_datetime.strftime('%l:%M%P')
        expect(will_open_at_string).to include "on #{panel.start_datetime.strftime('%-m/%-d/%Y')}"
      end
    end
  end
  ...
  context 'panel is today' do
    ...
    context 'will_close_at_string' do
      it 'does not include date in string' do
        will_close_at_string = will_close_at_string(panel: panel)
        expect(will_close_at_string).to include panel.end_datetime.strftime('%l:%M%P')
        expect(will_close_at_string).not_to include "on #{panel.end_datetime.strftime('%-m/%-d/%Y')}"
      end
    end
    ...
    context 'will_open_at_string' do
      it 'includes date in string' do
        ...
        expect(will_open_at_string).to include panel.start_datetime.strftime('%l:%M%P')
        expect(will_open_at_string).not_to include "on #{panel.start_datetime.strftime('%-m/%-d/%Y')}"
      end
    end
  end
