    ...
    describe 'search' do
      ...
      context 'reset search link' do
        ...
        scenario 'displays "reset search" link when there is a search param' do
          visit path
          fill_in 'q_submitter_first_name_or_submitter_last_name_or_reviewer_first_name_or_reviewer_last_name_cont', with: 'Submission'
          click_button 'Search'
      ...
      context 'no results' do
        scenario 'displays download all link when there are reviews' do
          visit path
          fill_in 'q_submitter_first_name_or_submitter_last_name_or_reviewer_first_name_or_reviewer_last_name_cont', with: 'supercalifragilistic'
          click_button 'Search'
          expect(page).to have_selector '#excel-export'
