...
RSpec.describe 'RegisteredUsers', type: :system, js: true  do
  describe '#index' do
    before(:each) do
      @user1         = create(:registered_user, last_name: 'BBBB',
                                     created_at: 65.minutes.ago,
                                     current_sign_in_at: 65.minutes.ago)
      @user2         = create(:registered_user, last_name: 'AAAA',
                                     created_at: 1.month.ago,
                                     current_sign_in_at: 1.day.ago)
      @grant_creator = create(:grant_creator_registered_user, last_name: 'ZZZZ',
                                                   created_at: 1.week.ago,
                                                   current_sign_in_at: 1.month.ago)
      @system_admin  = create(:system_admin_registered_user, last_name: 'CCCC',
  ...
  describe 'sign up new user' do
    ...
    scenario 'user sign in' do
      ...
      find_field('Unique ID').set('user3@example.com')
      find_field('Password').set('password')
      click_button 'Log in'
