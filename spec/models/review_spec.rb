  ...
  describe 'validations' do
    context '#new' do
      ...
      it 'prevents a review from being submitted after grant review close date' do
        ...
        expect(review).not_to be_valid
        expect(review.errors.messages[:base]).to include I18n.t('activerecord.errors.models.review.attributes.base.may_not_review_after_close_date', review_close_date: grant.review_close_date.to_fs)
      end
    end
