...
Devise.setup do |config|
  ...
  # config.secret_key = '1d25910d895c01d4326913ada6fe50fb224ff873a268d9b75dc38e7549c28326ec94fbec3825d19f27ee04624b054f7dda400d4c5be0be26a6bad1ef9dd0e208'
  ...
  # config.pepper = '0f712e32863cfe92b0e7862917d3eea01079f38abe1e9983ed9d34ffe6ac0be09ee165b27d8f4283a3400fe7b47597bd1c79df1dabf0f7afd0627743c30e87f0'
  ...
  config.allowed_clock_drift_in_seconds = 30
  ...
  config.saml_configure do |settings|
    ...
    settings.idp_cert                           = Rails.application.credentials.dig(Rails.env.to_sym, :idp_cert)
  end
end
