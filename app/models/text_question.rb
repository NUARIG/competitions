class TextQuestion < Question
  ...
  private
    def validate_maximum_and_minimum_lengths
      minimum_length = self.constraint_questions.find { |cq| cq.constraint.name == 'minimum_length' }.value.to_i
      maximum_length = self.constraint_questions.find { |cq| cq.constraint.name == 'maximum_length' }.value.to_i
