...
class FloatQuestion < IntegerQuestion
  ...
  def valid_maximum_and_minimum_values
    minimum_value = constraint_questions.find { |cq| cq.constraint.name == 'minimum_value' }.value
    maximum_value = constraint_questions.find { |cq| cq.constraint.name == 'maximum_value' }.value
